...
"POT_OBJECTS"                 : ControllerObjectClass(2 ,"POT_OBJECTS")
}
...
POT_OBJECTS    = {
"Poti"           : ControllerObjectClass(0 ,"POT_OBJECTS")
}
...
CONTROLLER_OBJECTS = CONTROLLER_GET_GROUPS | BINARY_OBJECTS | SHT20_OBJECTS | POT_OBJECTS | PWM_OBJECTS
