...
#ORDER IN BINARY:
#(MSB) PL1_B, PL1_G, PL1_R, TL1_G, TL1_Y, TL1_R, PL2_B, PL2_G, PL2_R, ->
#      TL2_G, TL2_Y, TL2_R, TL4_G, TL4_Y, TL4_R, TL3_G, TL3_Y, TL3_R (LSB)


"TRAFFIC_LIGHTS"    : ControllerObjectClass(None,"CONTROLLER_GET_GROUP_TRAFFIC_LIGHTS"),	

#predefines states							 #PL1 TL1 PL2 TL2 TL4 TL3
"ALL_ON"            : ControllerObjectClass(0b111_111_111_111_111_111,"CONTROLLER_GET_GROUP_TRAFFIC_LIGHTS"),
"ALL_RED"	        : ControllerObjectClass(0b001_001_001_001_001_001,"CONTROLLER_GET_GROUP_TRAFFIC_LIGHTS"),

"HORIZONTAL_YELLOW" : ControllerObjectClass(0b001_010_001_001_001_010,"CONTROLLER_GET_GROUP_TRAFFIC_LIGHTS"),
"HORIZONTAL_GREEN"  : ControllerObjectClass(0b001_100_001_001_001_100,"CONTROLLER_GET_GROUP_TRAFFIC_LIGHTS"),

"VERTICAL_YELLOW"   : ControllerObjectClass(0b001_001_001_010_010_001,"CONTROLLER_GET_GROUP_TRAFFIC_LIGHTS"),
"VERTICAL_GREEN"    : ControllerObjectClass(0b001_001_001_100_100_001,"CONTROLLER_GET_GROUP_TRAFFIC_LIGHTS"),

#individual states

"TL3_RED"           : ControllerObjectClass(1<<0 ,"CONTROLLER_GET_GROUP_TRAFFIC_LIGHTS"),
"TL3_YELLOW"        : ControllerObjectClass(1<<1 ,"CONTROLLER_GET_GROUP_TRAFFIC_LIGHTS"),
"TL3_GREEN"         : ControllerObjectClass(1<<2 ,"CONTROLLER_GET_GROUP_TRAFFIC_LIGHTS"),

"TL4_RED"           : ControllerObjectClass(1<<3 ,"CONTROLLER_GET_GROUP_TRAFFIC_LIGHTS"),
"TL4_YELLOW"        : ControllerObjectClass(1<<4 ,"CONTROLLER_GET_GROUP_TRAFFIC_LIGHTS"),
"TL4_GREEN"         : ControllerObjectClass(1<<5 ,"CONTROLLER_GET_GROUP_TRAFFIC_LIGHTS"),
...
"TL1_RED"           : ControllerObjectClass(1<<12,"CONTROLLER_GET_GROUP_TRAFFIC_LIGHTS"),
"TL1_YELLOW"        : ControllerObjectClass(1<<13,"CONTROLLER_GET_GROUP_TRAFFIC_LIGHTS"),
"TL1_GREEN"         : ControllerObjectClass(1<<14,"CONTROLLER_GET_GROUP_TRAFFIC_LIGHTS"),

"PL1_RED"           : ControllerObjectClass(1<<15,"CONTROLLER_GET_GROUP_TRAFFIC_LIGHTS"),
"PL1_GREEN"         : ControllerObjectClass(1<<16,"CONTROLLER_GET_GROUP_TRAFFIC_LIGHTS"),
"PL1_BLUE"          : ControllerObjectClass(1<<17,"CONTROLLER_GET_GROUP_TRAFFIC_LIGHTS")
