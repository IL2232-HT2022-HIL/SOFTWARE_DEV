...
__attribute__ ((section(".RxDecripsection"), used)) ETH_DMADescTypeDef  DMARxDscrTab[ETH_RXBUFNB];

__attribute__ ((section(".TxDecripSection"), used)) ETH_DMADescTypeDef  DMATxDscrTab[ETH_TXBUFNB];
