...
/* Definitions for taskBlu */
osThreadId_t taskBluHandle;
const osThreadAttr_t taskBlu_attributes = {
  .name = "taskBlu",
  .stack_size = 128 * 4,
...
/* USER CODE BEGIN Header_StartTaskBlu */
/**
* @brief Function implementing the taskBlu thread.
* @param argument: Not used
* @retval None
*/
