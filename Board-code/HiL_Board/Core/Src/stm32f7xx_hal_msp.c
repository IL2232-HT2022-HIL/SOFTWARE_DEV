...
void HAL_CAN_MspDeInit(CAN_HandleTypeDef* hcan)
{
  ...
  /* USER CODE END CAN1_MspDeInit 0 */
    ...
    PD1     ------> CAN1_TX
    */
    HAL_GPIO_DeInit(GPIOD, HiL_CAN1_RX_Pin|HiL_CAN1_TX_Pin);
...
void HAL_DAC_MspDeInit(DAC_HandleTypeDef* hdac)
{
  ...
  /* USER CODE END DAC_MspDeInit 0 */
    ...
    PA4     ------> DAC_OUT1
    */
    HAL_GPIO_DeInit(HiL_Poti_GPIO_Port, HiL_Poti_Pin);
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C1_MspDeInit 0 */
    ...
    PB9     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(HiL_I2C1_SCL_GPIO_Port, HiL_I2C1_SCL_Pin);

    HAL_GPIO_DeInit(HiL_I2C1_SDA_GPIO_Port, HiL_I2C1_SDA_Pin);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI1_MspDeInit 0 */
    ...
    PB3     ------> SPI1_SCK
    */
    HAL_GPIO_DeInit(HiL_595_DS_GPIO_Port, HiL_595_DS_Pin);

    HAL_GPIO_DeInit(HiL_595_SHCP_GPIO_Port, HiL_595_SHCP_Pin);
  ...
  /* USER CODE END SPI3_MspDeInit 0 */
    ...
    PC10     ------> SPI3_SCK
    */
    HAL_GPIO_DeInit(HiL_SPI3_MOSI_GPIO_Port, HiL_SPI3_MOSI_Pin);

    HAL_GPIO_DeInit(HiL_SPI3_SCK_GPIO_Port, HiL_SPI3_SCK_Pin);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM1_MspDeInit 0 */
    ...
    PE9     ------> TIM1_CH1
    */
    HAL_GPIO_DeInit(HiL_595_Enable_GPIO_Port, HiL_595_Enable_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END UART7_MspDeInit 0 */
    ...
    PE8     ------> UART7_TX
    */
    HAL_GPIO_DeInit(GPIOE, HiL_UART7_RX_Pin|HiL_UART7_TX_Pin);
